...
from stoix.utils.loss import clipped_value_loss
        ...
        def _update_epoch(update_state: Tuple, _: Any) -> Tuple:
            ...
            def _update_minibatch(train_state: Tuple, batch_info: Tuple) -> Tuple:
                ...
                def _actor_loss_fn(
                    ...
                    # CALCULATE LOSS
                    actor_loss = tfd.Categorical(probs=traj_batch.search_policy).kl_divergence(actor_policy).mean()
...
) -> Tuple[LearnerFn[LearnerState], RootFnApply, SearchApply, LearnerState]:
