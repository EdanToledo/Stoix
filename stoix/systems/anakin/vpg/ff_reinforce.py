...
from stoix.systems.anakin.vpg.vpg_types import Transition
...
def get_learner_fn(
    ...
    def _update_step(learner_state: LearnerState, _: Any) -> Tuple[LearnerState, Tuple]:
        def _env_step(learner_state: LearnerState, _: Any) -> Tuple[LearnerState, Transition]:
            ...
            transition = Transition(done, action, value, timestep.reward, last_timestep.observation, info)
        ...
        critic_grads, critic_loss_info = critic_grad_fn(params.critic_params, traj_batch.obs, monte_carlo_returns)
...
@hydra.main(config_path="../../../configs", config_name="default_ff_reinforce.yaml", version_base="1.2")
