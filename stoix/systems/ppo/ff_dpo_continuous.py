...
from stoix.utils.loss import clipped_value_loss, dpo_loss
...
def get_learner_fn(
    ...
    def _update_step(learner_state: LearnerState, _: Any) -> Tuple[LearnerState, Tuple]:
        ...
        def _env_step(learner_state: LearnerState, _: Any) -> Tuple[LearnerState, PPOTransition]:
            ...
            transition = PPOTransition(done, action, value, timestep.reward, log_prob, last_timestep.observation, info)
        ...
        def _update_epoch(update_state: Tuple, _: Any) -> Tuple:
            ...
            def _update_minibatch(train_state: Tuple, batch_info: Tuple) -> Tuple:
                ...
                def _actor_loss_fn(
                    ...
                    loss_actor = dpo_loss(log_prob, traj_batch.log_prob, gae, config.system.alpha, config.system.beta)
            ...
            # UPDATE MINIBATCHES
            (params, opt_states, key), loss_info = jax.lax.scan(_update_minibatch, (params, opt_states, key), minibatches)
...
@hydra.main(config_path="../../configs", config_name="default_ff_dpo_continuous.yaml", version_base="1.2")
