...
from stoix.networks.ffm_edan import FFMCell, MemoroidResetWrapper, ScannedMemoroid
...
def learner_setup(
    ...
    actor_rnn = BatchFFM(
        cell=MemoroidResetWrapper(
            cell=FFMCell(output_size=output_size, trace_size=trace_size, context_size=context_size)
        )
    )
