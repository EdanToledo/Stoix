...
def get_act_fn(
    ...
    [ActorCriticParams, Observation, chex.PRNGKey], Tuple[Action, LogProb, chex.PRNGKey, Observation]
]:
    ...
    def _update_step(
        ...
        def _update_minibatch(train_state: Tuple, batch_info: Tuple) -> Tuple:
            ...
            critic_grads, critic_loss_info = critic_grad_fn(
                params.critic_params, params.actor_params, obs_batch,
            ...
            critic_grads, actor_grads, critic_loss_info, actor_loss_info = jax.lax.pmean(
                (critic_grads, actor_grads, critic_loss_info, actor_loss_info), axis_name="learner_devices"
            )
        ...
        chex.assert_tree_shape_prefix((a_tm1, r_t, d_t, behavior_log_prob_tm1), (config.system.rollout_length, envs_per_batch,))
        ...
        chex.assert_tree_shape_prefix(minibatches[1:], (config.system.num_minibatches, config.system.rollout_length, envs_per_minibatch,))
